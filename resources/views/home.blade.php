                    ...
                    <div class="container pt-11 pt-md-13 pb-19 pb-md-17">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-8 col-xxl-7 mx-auto  text-center" data-cues="slideInDown"
                                ...
                                <h3 class="display-1 ls-sm fs-40 mb-4 px-md-8 px-lg-0">Welcome {{ Auth::user()->username
                                    }}</h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="check-av" method="POST">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <p class="mb-5 text-muted"> Choose your prefered country and service
                                                    </p>
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-lg mt-6">Check
                                                        availability</button>
                                        ...
                                        <div class="row">
                                            ...
                                            @if(Auth::user()->wallet < $price) <a href="fund-wallet"
                                                ...
                                                <form action="order_now" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-dark btn-lg mt-6">Order
                                                        Now</button>
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><span>{{$data->expires_in}}s</span></td>
                                                        <td class="text-bold"><strong>{{ $data->phone }}</strong></td>
                                                        @if($data->message == null)
                                                        <td><span class="text-muted text-small">Waiting for Sms<span>
                                                        </td>
                                                        @else
                                                        <td>{{$data->message}}</td>
                                                        @endif
                                                        @if($data->status == 0)
                                                        <td><a href"" class="btn btn-warning btn-sm">Recheck SMS</a>
                                                        </td>
                                                        @elseif($data->status == 1)
                                                        <td><a href="cancle-sms?id={{$data->id}}" class="btn btn-danger
                                                                btn-sm"><i class="bi bi-trash"></i>
                                                            </a></td>
                                                        <td><a href="check-sms?id={{$data->id}}" class="btn btn-warning
                                                                text-white text-bold btn-sm"><i
                                                                    class="bi bi-arrow-clockwise"></i></a></td>
                                                        @else
                                                        <td><a href="" class="btn btn-success btn-sm"><i
                                                                    class="bi bi-check-circle-fill"></i></a></td>
                                                        @endif
                                                        @empty

                                                        <td class="text-muted"> No orders available</td>
