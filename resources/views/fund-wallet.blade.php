    ...
    <div class="default-theme">
        ...
        <div wire:id="k3avItmW0YN9EgcVBf0J"
            ...
            <form id="myDiv" action="fund-now" class="grid grid-cols-1 gap-3" method="POST">
                ...
                <label class="mt-3 text-gray-600 font-bold text-sm">Enter the Amount (NGN)</label>
                <div class="flex">
                    <span
                    ...
                    <input
                        class="border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary focus:ring-opacity-50 rounded-md shadow-sm block w-full rounded-l-none"
